      ...
      preguntas: [
        {
          id: 1,
          texto:
            'El somatotipo ectomorfo se caracteriza por hombros anchos y gran desarrollo muscular',
        ...
        },
        {
          id: 2,
          texto:
            'En el análisis de siluetas masculinas, la forma de triángulo invertido representa hombros más anchos que la cintura.',
          imagen: require('@/assets/actividad/imagen1.png'),
          barajarRespuestas: true,
          opciones: [
            {
        ...
        },
        {
          id: 3,
          texto:
            'El somatotipo endomorfo suele presentar una acumulación de volumen en la zona abdominal y en el pecho.',
          imagen: require('@/assets/actividad/imagen1.png'),
          barajarRespuestas: true,
          opciones: [
            {
        ...
        },
        {
          id: 4,
          texto:
            'La silueta rectangular se define por tener hombros, cintura y caderas con proporciones similares.',
          imagen: require('@/assets/actividad/imagen1.png'),
          barajarRespuestas: true,
          opciones: [
            {
        ...
        },
        {
          id: 5,
          texto:
            'El somatotipo mesomorfo tiende a tener extremidades largas y delgadas, con poca masa muscular.',
        ...
        },
        {
          id: 6,
          texto:
            'La clasificación de los somatotipos masculinos ayuda a diseñar patrones de prendas superiores más ajustados a cada tipo de cuerpo.',
          imagen: require('@/assets/actividad/imagen2.png'),
          barajarRespuestas: true,
          opciones: [
            {
